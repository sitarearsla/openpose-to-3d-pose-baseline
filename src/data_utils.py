...
def create_2d_data(actions, data_dir, rcams, dim):
  ...
  """
    ...
    # Load 3d data
    train_set = load_data(data_dir, TRAIN_SUBJECTS, actions, dim)
    test_set = load_data(data_dir, TEST_SUBJECTS, actions, dim)
